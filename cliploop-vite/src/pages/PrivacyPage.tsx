...
export default function PrivacyPage() {
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="cl-card p-6 md:p-8 max-w-3xl mx-auto">
      ...
      <p className="mt-3 text-sm leading-6 text-[#8B8B8B] text-[#8B8B8B]">For questions, contact <a href="mailto:support@cliploop.site" className="text-white hover:underline">support@cliploop.site</a>.</p>
    </motion.div>
  );
}
