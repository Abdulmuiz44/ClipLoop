...
import type { WebsiteCrawlPage } from "@/core/context/contracts";
...
export async function crawlWebsiteContext(input: { websiteUrl: string; maxPages?: number; maxCharsPerPage?: number }): Promise<WebsiteCrawlPage[]> {
