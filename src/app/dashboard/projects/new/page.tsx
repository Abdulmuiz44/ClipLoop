  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="space-y-2">
        ...
        <h1 className="text-3xl font-bold">Set up the product once, then run the weekly loop</h1>
        <p className="max-w-2xl text-sm text-slate-600">
          Keep the setup concrete. The stronger the product context and CTA here, the better your first strategy cycle and post pack will be.
        </p>
      </div>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="rounded border bg-white p-4 text-sm">
          ...
          <p className="mt-1 text-slate-600">Create the project and store your core positioning.</p>
        </div>
        <div className="rounded border bg-white p-4 text-sm">
