...
const outFile = resolve(
  '/root/projects/cliplane/apps/cliplane-demo-video/dist/cliplane-v0.1.0-demo.mp4',
);
...
const ffmpegArgs = [
  ...
  '-vf',
  [
    "drawtext=fontcolor=white:fontsize=58:x=(w-text_w)/2:y=140:text='ClipLane v0.1.0'",
    ...
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,5,10)':text='npx @talocode/cliplane'",
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,11,16)':text='cliplane init'",
    "drawtext=fontcolor=white:fontsize=28:x=160:y=520:enable='between(t,11,16)':text='Create a local video workflow.'",
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,17,22)':text='cliplane script --update \"we shipped Codra v0.1.5\"'",
    "drawtext=fontcolor=white:fontsize=28:x=160:y=520:enable='between(t,17,22)':text='Turn product updates into a launch script.'",
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,23,28)':text='cliplane storyboard --script .cliplane/scripts/latest.md'",
    "drawtext=fontcolor=white:fontsize=28:x=160:y=520:enable='between(t,23,28)':text='Generate a structured video storyboard.'",
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,29,34)':text='cliplane render'",
    "drawtext=fontcolor=white:fontsize=28:x=160:y=520:enable='between(t,29,34)':text='Render a simple promo video locally.'",
    "drawtext=fontcolor=white:fontsize=38:x=160:y=440:enable='between(t,35,40)':text='cliplane export x'",
    ...
    "drawtext=fontcolor=white:fontsize=34:x=(w-text_w)/2:y=920:enable='between(t,45,48)':text='ClipLane — Video workflow for indie app builders'",
